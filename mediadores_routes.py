# mediadores_routes.py — Alta de Mediadores completa (auto-aprobado + correo con soft-fail)
...
def register(data: MediadorIn):
    """Registra un mediador y lo deja aprobado/activo automáticamente."""
    if not data.accept:
    ...
    # Envío de correos: si falla el SMTP no rompe la API
    try:
        ...
        # No detenemos el alta si hay error de correo
        pass
